...
#include "../Types.h"
#include "NetlabTAU/include/Sniffer/tins.h"
...
public:
	...
	*/
	int sendToL4(byte *sendData, size_t sendDataLen, std::string destIP, std::string srcIP = "", Tins::ICMP::Flags flag = Tins::ICMP::Flags::ECHO_REQUEST);
	...
	*/
	virtual int recvFromL4(byte* sendData, size_t sendDataLen, std::string destIP);
